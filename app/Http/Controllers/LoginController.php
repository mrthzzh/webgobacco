...
class LoginController extends Controller
{
    ...
    public function postLogin(Request $request)
    {
        ...
        if (isset($petani)) {
            ...
            $request->session()->put('user_type', 'petani'); // Menambahkan informasi user_type sebagai 'petani'
            ...
            if (isset($pemerintah)) {
                ...
                $request->session()->put('user_type', 'pemerintah'); // Menambahkan informasi user_type sebagai 'pemerintah'
                ...
                if (isset($admin)) {
                    ...
                    $request->session()->put('user_type', 'admin'); // Menambahkan informasi user_type sebagai 'admin'
