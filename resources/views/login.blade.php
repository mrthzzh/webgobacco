        ...
        <div class="min-h-screen flex justify-center">
            ...
            <div class="flex flex-col items-center bg-light-secondary w-1/2">
                ...
                <div class="text-light-putih font-bold text-2xl mt-10 text-center">Selamat Datang!
                    ...
                    <a href="/register" class="mt-6 inline-block text-center font-bold bg-light-secondary text-light-putih py-2.5 px-20 rounded-full border hover:bg-light-fill focus:shadow-outline  text-base">REGISTER</a>   
                </div>                                                                                                                           
            </div>
        </div>                                           
    </section>
