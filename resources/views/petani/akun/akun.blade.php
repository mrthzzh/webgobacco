            ...
            <div class="grid grid-cols-10 h-screen">
                ...
                <div class="col-span-8 bg-light-secondary relative"> 
                    <div class=" flex flex-col justify-between bg-light-primary absolute z-50 bottom-0 w-[90%] h-[85%] p-12 rounded-tr-[3rem] rounded-tl-[3rem]">
                        <div class="">
                            <h3 class="text-2xl font-bold text-light-secondary text-opacity-70">Akun Petani</h3>
                            <div class="grid grid-cols-6 gap-0">
                                <div class="col-span-6 sm:col-span-3">
                                    <h1 for="id" class="text-base font-semibold text-light-secondary opacity-70 block mb-2 mt-4">ID Customer :</h1>
                                    <h1 for="id" class="text-sm font-medium text-light-secondary opacity-70 block mb-2">{{ $petani->id_petani }}</h1>
                                </div>
                                <div class="col-span-6 sm:col-span-3">
                                    <h1 for="no-hp" class="text-base font-semibold text-light-secondary opacity-70 block mb-2 mt-4">No. Handphone :</h1>
                                    <h1 for="no-hp" class="text-sm font-medium text-light-secondary opacity-70 block mb-2">{{ $petani->telp_petani }}</h1>
                                </div>
                                <div class="col-span-6 sm:col-span-3">
                                    <h1 for="nama" class="text-base font-semibold text-light-secondary opacity-70 block mb-2 mt-2">Nama Lengkap :</h1>
                                    <h1 for="nama" class="text-sm font-medium text-light-secondary opacity-70 block mb-2">{{ $petani->nama_petani }}</h1>
                                </div>
                                <div class="col-span-6 sm:col-span-3">
                                    <h1 for="ktp" class="text-base font-semibold text-light-secondary opacity-70 block mb-2 mt-2">No. KTP :</h1>
                                    <h1 for="ktp" class="text-sm font-medium text-light-secondary opacity-70 block mb-2">{{ $petani->noktp_petani }}</h1>
                                </div>
                                <div class="col-span-6 sm:col-span-3">
                                    <h1 for="username" class="text-base font-semibold text-light-secondary opacity-70 block mb-2 mt-2">Username :</h1>
                                    <h1 for="username" class="text-sm font-medium text-light-secondary opacity-70 block mb-2">{{ $petani->username_petani }}</h1>
                                    
                                </div>
                                <div class="col-span-6 sm:col-span-3">
                                    <h1 for="alamat" class="text-base font-semibold text-light-secondary opacity-70 block mb-2 mt-2">Alamat :</h1>
                                    <h1 for="alamat" class="text-sm font-medium text-light-secondary opacity-70 block mb-2">{{ $petani->alamat_petani }}</h1>
                                </div>
                                <div class="col-span-6 sm:col-span-3">
                                    <h1 for="password" class="text-base font-semibold text-light-secondary opacity-70 block mb-2 mt-2">Password :</h1>
                                    <h1 for="password" class="text-sm font-medium text-light-secondary opacity-70 block mb-2">{{ $petani->pw_petani }}</h1>
                                </div>
                                <div class="col-span-6 sm:col-span-3">
                                ...
                                <div class="col-span-6 sm:col-span-3">
                                    ...
                                    <h1 for="email" class="text-sm font-medium text-light-secondary opacity-70 block mb-2">{{ $petani->email_petani }}</h1>
                                ...
                                <div class="col-span-6 sm:col-span-3">
                                    <h1 for="jenis-kelamin" class="text-base font-semibold text-light-secondary opacity-70 block mb-2 mt-2">Jenis Kelamin :</h1>
                                    <h1 for="jenis-kelamin" class="text-sm font-medium text-light-secondary opacity-70 block mb-2">{{ $jenis_kelamin->jenis_kelamin }}</h1>                                    
                                </div>                                
                            </div>
                        <div class="text-center">
                            <a href="/petani/ubah" class="cursor-pointer rounded-full bg-light-button px-10 py-4 text-sm font-bold text-white hover:opacity-80">Ubah Profil                               
                            </a>
                        </div>     
                    </div>
                </div>               
