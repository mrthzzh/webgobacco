        ...
        <div class="bg-light-primary relative">
            ...
            <div class="grid grid-cols-10 h-screen">
                ...
                <div class="col-span-8 bg-light-secondary relative"> 
                    <form action="/petani/ubah" method="post" class=" flex flex-col justify-between bg-light-primary absolute z-20 bottom-0 w-[90%] h-[85%] p-10 rounded-tr-[3rem] rounded-tl-[3rem]">
                        @csrf
                        @method('patch')
                        <div class="">                            
                            <div class="grid grid-cols-6 gap-2 ">
                                <div class="col-span-6 sm:col-span-3 mr-20">
                                    <label for="nama" class="text-sm font-medium text-light-secondary opacity-70 block mb-2 mt-6">Nama Lengkap</label>
                                    <input type="text" name="nama_petani" id="nama" value="{{ $petani->nama_petani }}" class="shadow-sm bg-light-fill bg-opacity-50 text-light-secondary rounded-lg block w-full p-2.5 focus:outline-slate-400 " required="">
                                </div>
                                <div class="col-span-6 sm:col-span-3 mr-20">
                                    <label for="no-hp" class="text-sm font-medium text-light-secondary opacity-70 block mb-2 mt-6">No. Handphone</label>
                                    <input type="number" name="telp_petani" value="{{ $petani->telp_petani }}" id="no-hp" class="shadow-sm bg-light-fill bg-opacity-50 text-light-secondary rounded-lg block w-full p-2.5 focus:outline-slate-400 " required="">
                                </div>
                                <div class="col-span-6 sm:col-span-3 mr-20">
                                    <label for="username" class="text-sm font-medium text-light-secondary opacity-70 block mb-2">Username</label>
                                    <input type="text" name="username_petani" value="{{ $petani->username_petani }}" id="username" class="shadow-sm bg-light-fill bg-opacity-50 text-light-secondary rounded-lg block w-full p-2.5 focus:outline-slate-400" required="">
                                </div>
                                <div class="col-span-6 sm:col-span-3 mr-20">
                                    <label for="ktp" class="text-sm font-medium text-light-secondary opacity-70 block mb-2 ">No.KTP</label>
                                    <input type="number" name="noktp_petani" id="ktp" value="{{ $petani->noktp_petani }}" class="shadow-sm bg-light-fill bg-opacity-50 text-light-secondary rounded-lg block w-full p-2.5 focus:outline-slate-400" required="">
                                </div>
                                <div class="col-span-6 sm:col-span-3 mr-20">
                                    <label for="password" class="text-sm font-medium text-light-secondary opacity-70 block mb-2">Password</label>
                                    <input type="text" name="pw_petani" value="{{ $petani->pw_petani }}" id="password" class="shadow-sm bg-light-fill bg-opacity-50 text-light-secondary rounded-lg block w-full p-2.5 focus:outline-slate-400"  required="">
                                </div>
                                <div class="col-span-6 sm:col-span-3 mr-20">
                                    <label for="alamat" class="text-sm font-medium text-light-secondary opacity-70 block mb-2">Alamat</label>
                                    <input type="text" name="alamat_petani" value="{{ $petani->alamat_petani }}" id="alamat" class="shadow-sm bg-light-fill bg-opacity-50 text-light-secondary rounded-lg block w-full p-2.5 focus:outline-slate-400" required="">
                                </div>
                                <div class="col-span-6 sm:col-span-3 mr-20">
                                    <label for="email" class="text-sm font-medium text-light-secondary opacity-70 block mb-2">Email</label>
                                    <input type="email" name="email_petani" value="{{ $petani->email_petani }}" id="email" class="shadow-sm bg-light-fill bg-opacity-50 text-light-secondary rounded-lg block w-full p-2.5 focus:outline-slate-400"  required="">
                                </div>
                                ...
                                <div class="col-span-6 sm:col-span-3 mr-20">
                                    ...
                                    <input type="text" name="jenis_kelamin" value="{{ $jenis_kelamin->jenis_kelamin }}" id="email" class="shadow-sm bg-light-fill bg-opacity-50 text-light-secondary rounded-lg block w-full p-2.5 focus:outline-slate-400"  required="">
                                </div>
                            </div>
                        </div>
                        <div class="text-center mt-4">
                            <a href="/petani/akun" class="cursor-pointer rounded-full bg-light-button px-10 py-4 text-sm font-bold text-white hover:opacity-80">Batal                            
                            </a>
                        <button
