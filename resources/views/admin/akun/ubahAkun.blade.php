            ...
            <div class="grid grid-cols-10 h-screen">
                <div class=" col-span-2 bg-light-secondary flex flex-col justify-between relative">
                    <div>
                        ...
                        <a href="/admin/dashboard" class="flex items-center px-4 py-2 mt-2 text-gray-100 hover:bg-light-button hover:rounded-full">
                            <div class="">
                ...
                <div class="col-span-8 bg-light-secondary relative"> 
                    <form action="/admin/ubah" method="post" class=" flex flex-col justify-between bg-light-primary absolute z-20 bottom-0 w-[90%] h-[85%] p-20 rounded-tr-[3rem] rounded-tl-[3rem]">
                        @csrf
                        @method('patch')
                        <div class="">
                            <div class=" grid grid-cols-6 gap-8 ">
                                <div class="col-span-6 sm:col-span-3 ">
                                    <label for="username" class="text-sm font-medium text-light-secondary opacity-70 block mb-2 mt-10 ">Username</label>
                                    <input type="text" name="username" id="username" value="{{ $admin->username }}" class="shadow-sm bg-light-fill bg-opacity-50 text-light-secondary rounded-lg block w-full p-2.5 focus:outline-slate-400">
                                </div>
                                <div class="col-span-6 sm:col-span-3">
                                ...
                                <div class="col-span-6 sm:col-span-3">
                                    ...
                                    <input type="text" name="password" id="password" value="{{ $admin->password }}" class="shadow-sm bg-light-fill bg-opacity-50 text-light-secondary rounded-lg block w-full p-2.5 focus:outline-slate-400">
                                </div>
                        ...
                        <div class="text-center">
                            <a href="/admin/akun" class="cursor-pointer rounded-full bg-light-button px-10 py-4 text-sm font-bold text-white hover:opacity-80">Batal                            
                            </a>
                            <button type="submit"
