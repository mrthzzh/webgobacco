            ...
            <div class="grid grid-cols-10 h-screen">
                ...
                <div class="tengah" style="z-index:998; margin-top: 110px;height:635px; width:1105px; background-color:#F5F5DC; border-radius: 50px 50px 0 0; display:flex; justify-content:center;">
                    <div id="edukasi" class="Edukasi">
                        <h2 style="font-family: 'Poppins', sans-serif;">List Data User Gobacco</h2>
                        <div class="image2-container" style="margin-bottom: 1000px; height: max-content; ">
                            <div class="image2-wrapper">
                                <div class="logopemerintah"><img src="../images/logopemerintah.png" alt="Gambar 1"></div>
                                <h5 style="font-family: 'Poppins', sans-serif">Data Akun Pemerintah</h5>
                                <a href="/admin/pemerintah"><button class="lihat-detail" style="font-family: 'Poppins', sans-serif;">Lihat Detail</button><a>
                            </div>
                            <div class="image2-wrapper">
                                <div class="logopetani"><img src="../images/logopetani.png" alt="Gambar 1"></div>
                                <h5 style="font-family: 'Poppins', sans-serif">Data Akun Petani Tembakau</h5>
                                <a href="/admin/petani"><button class="lihat-detail" style="font-family: 'Poppins', sans-serif;">Lihat Detail</button></a>
                            </div>
                        </div>
                    </div>
                </div>
